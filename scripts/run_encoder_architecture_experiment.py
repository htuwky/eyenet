...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pretrain-schema", default="configs/features/encoder_original_13feature_core.json")
    ...
    parser.add_argument("--downstream-schema", default="configs/features/encoder_original_13feature_core.json")

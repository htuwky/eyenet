...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the EMS dual-stream concat model with a fixed train/valid/test split."
    )
    parser.add_argument("--config", default="configs/experiments/ems_dual_stream.yaml")
    ...
    parser.add_argument("--output-dir", default="experiments/ems_fixed_split/dual_stream_concat")
...
def main() -> None:
    ...
    print("Fixed-split Dual-Stream Concat test metrics using validation-selected best balanced-accuracy threshold")

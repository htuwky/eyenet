...
from eyenet.training.segment_sequence import (
    ...
    save_fixed_split_segment_sequence_outputs,
    train_fixed_split,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the EMS Macro-Behavior Stream with a fixed train/valid/test split."
    )
    parser.add_argument("--config", default="configs/experiments/ems_macro_behavior_fixed_split.yaml")
    ...
    parser.add_argument("--output-dir", default="experiments/ems_fixed_split/macro_behavior_sequence")
...
def main() -> None:
    ...
    args.segments = cfg_arg(args, config, "segments", "data.segments")
    ...
    print("Fixed-split Macro-Behavior Stream test metrics using validation-selected best balanced-accuracy threshold")
